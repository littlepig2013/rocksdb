...
enum CompactionPri : char {
  ...
  // Keeps a cursor(s) of which file (key range) was/were compacted before,
  // and always picks the next files (key range) in that level. The file
  // picking process will cycle through all the files in a round-robin manner
  kRoundRobin = 0x4,
};
